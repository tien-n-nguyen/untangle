...
the changed nodes. Note: for a given {\mvpdg}, the number of
clusters is unknown to the model, and will be decided by the model
during agglomerative clustering. Let us detail those two tasks.

%of our CC clustering learning model.
...
\begin{figure*}[t]
	\centering \includegraphics[width=5.6in]{figures/STEP_2-new-4.png}
	\vspace{-6pt}
...
is the {\em node feature vector} for $n$. Then, we build the graph with the
