...
This task is aimed to build the vector representations (i.e.,
...
labels (i.e., $i$, $j$, $(i,j)$) representing the (un)changes, {\tool}
uses Label-GCN~\cite{label-gcn} to model the graph to better learn the useful
information from the node features with the labels.
