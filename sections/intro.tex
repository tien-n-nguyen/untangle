...
classified into two categories: {\em mining software repositories},
and {\em program analysis}.
...
which are used in an agglomerative clustering algorithm to partition
tangled changes.
