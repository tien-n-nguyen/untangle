...
\textcolor{red}{Our empirical evaluation on a real-world C\# dataset
  with 21k commits and 1,612 concerns shows that {\tool} achieves the
  ...
  commits and X,XXX concerns. The results show that {\tool} achievers
  higher accuracy XX.X\% relatively than the state-of-the-art
  approach.}
