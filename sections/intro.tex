...
edges. Applying a clustering algorithm on the PDG, slices, or changes
...
commit could be due to the reasons different from the program
...
%clustering on embeddings rich info than PDG, slices, or changes
