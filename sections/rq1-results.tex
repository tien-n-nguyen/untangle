...
accuracy is measured on the changed statements. As seen, {\tool}
improves $Accuracy^c$ by {\bf 462.5\%, 55.2\%, 28.6\%, and 36.4\%} in
comparison with Barnett {\em et al.}, Herzig {\em et al.},
$\sigma-$PDG+CV, and Flexeme, respectively.
