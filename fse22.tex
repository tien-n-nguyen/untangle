...
commit. We develop a novel code change representation learning model
...
relationships. The contexts of the changes and cloned code are
explicitly represented, helping the model distinguish their
concerns/purposes. Our empirical evaluation on real-world datasets
show that ...
\end{abstract}
