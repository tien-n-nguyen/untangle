...
change representation learning model}, leveraging Graph-based
...
%
\textcolor{red}{Our empirical evaluation on a real-world C\# dataset with 21k commits and 1,612 concerns shows that it achieves the accuracy of XX.X\%--XX\% and YY.Y\%--YY.Y\% relatively higher than the state-of-the-art approaches in cross-project and within-project settings. We also evaluated {\tool} in a Java dataset with XX commits. The results show that it achieves accuracy XX.X\% relatively higher than the state-of-the-art approach.
