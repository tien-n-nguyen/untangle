...
different purposes, both hampering program comprehension and reduce
...
contexts and cloned code are explicitly represented, helping {\tool}
...
approaches in clustering the changed code. We also
